...
/*IMG iphone*/
gsap.from('.img3', {opacity: 0, duration: 2, delay: 1.2, y: -40})
gsap.from('.img4', {opacity: 0, duration: 2, delay: 1.4, y: 40})

/*NAV*/
gsap.from('.navlogo', {opacity:0, duration: 2.5, delay: 1.5, y: 25});
...
gsap.from('.navbtn', {opacity:0, duration: 2.5, delay: 2, y: 25});
